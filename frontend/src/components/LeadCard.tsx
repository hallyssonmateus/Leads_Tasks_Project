...
const LeadCard: React.FC<LeadCardProps> = ({ lead }) => {
  ...
  return (
    <div className="bg-white p-6 rounded-sm shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
        ...
        <button 
          ...
          title="More actions"
          // Aqui você implementaria um dropdown/menu de contexto
          // onClick={() => console.log('Abrir menu para:', lead.name)} 
        >
          <MdMoreVert size={20} />
        </button>
      </div>
      ...
      <button 
        ...
        className="mt-6 w-full text-center py-2 text-sm font-semibold cursor-pointer 
                   text-zinc-400 border border-blue-400 rounded-lg 
